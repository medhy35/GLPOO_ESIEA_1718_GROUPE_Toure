...
public class CsvTirageDao {
	 ...
	 * Traitement du csv
	 * @param	fichier csv
	 * @return	retourne le fichier transform� en objet java
	 */
	
	//Lien d'acc�s vers le fichier csv
	private String link = "src/main/resources/euromillions.csv";
	...
	private Tirage lineToTirage(final String line) throws ParseException {
		...
		/*
		 * Author: Gabrielle On recupere le tirage du fichier par attributs de la
		 * classe. On compte les lignes apr�s chaque ";". Pour les variables de type
		 * "double", on doit adapter la d�cimale ('.' au lieu de ',')
		 */
		...
		tirage.setWinStarASC(colonnes[13]);// Ordre croissant des �toiles
