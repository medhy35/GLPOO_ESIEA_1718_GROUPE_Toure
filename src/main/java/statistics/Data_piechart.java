...
public class Data_piechart {
	 ...
	 * @param	Base de don�es type PieDataset et un titre type String
	...
	public static PieDataset result_round(ArrayList<Tirage> path){
		...
		int compteur = 0;
		//Parcours tous les num�ros de boules possibles
		for(int i=1;i<51;i++) {
			//Parcours toutes les lignes du tableau
			for(int j=0;j<path.toArray().length;j++) {
				//Si l'�l�ment appara�t on incr�mente le compteur
			...
			//Rajout des informations � la base
