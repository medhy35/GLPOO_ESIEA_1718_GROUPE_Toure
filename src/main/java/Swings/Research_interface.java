...
public Research_interface(){
		...
		JLabel star_label = Labels.create_label("Rang �toile :","Tahoma",11,"red","white");
		...
		JRadioButton picture_button = Buttons.create_radiobutton("Sch�ma(s)","gold");
		...
		JComboBox<String> date_month = Buttons.create_ComboBox(new String[] { "Janvier", "F�vrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "D�cembre", "Inconnu" });
