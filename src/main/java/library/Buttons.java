...
public class Buttons {
	...
	public static JMenuBar create_menubar_bis(JMenuItem Item1,JMenuItem Item2,JMenuItem Item3,JMenuItem Item4,JMenuItem Item5,JMenuItem Item6,JMenuItem Item7,JMenuItem Item8,JMenuItem Item9){
		JMenuBar main_bar = new JMenuBar();
		JMenu acces_button = new JMenu("Ficher");
